...
pretrain_samples = meta_info[meta_info['organ']!='Lymph node']['sample'].tolist()

evaluation_samples = meta_info[meta_info['organ']=='Lymph node']['sample'].tolist()
evaluation_samples = evaluation_samples[:3] + evaluation_samples[4:]
# train_samples = [evaluation_samples[0]]
# test_samples = evaluation_samples[1:3] + [evaluation_samples[4]]
...
pretrain_model_path = f'../model_checkpoints/transformer_pretrain_visium_-lymphnode.pth'
tmp_model_path = f'../tmp_checkpoints/{args.method}_{args.mode}_visium_-lymphnode_{args.split_protocol}.pth'
result_path = f'../result/{args.method}_{args.mode}_visium_-lymphnode_{args.split_protocol}.csv'
